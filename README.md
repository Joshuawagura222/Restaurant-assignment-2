...
<body>
  ...
  <!--map  element-->
    <div id="map" style="width: 75%; height:500px;position:absolute;top:10%; margin: auto; margin-left: 150px;"></div>
    ...
    <script>
        ...
        var map = L.map(map1, {
            center: [3.120505128393162, 35.6046590918462],
            zoom: 6,
     ...
     <footer style="float:bottom;position:absolute;bottom:1%;right:5%">
<p>Joshua Wagura<p>
<p>ENC222-0146/2017</p>
</footer>
<p style="float:bottom;position:absolute;bottom:1%;right:50%">&copy copyright Joshua Wagura</p>
